...
func (d *DelphiController) GetCoinsV2(c *gin.Context) {
	...
	for _, coin := range availableCoins {
		if coin.Info.Tag == "BAT" || coin.Info.Tag == "LINK" || coin.Info.Tag == "MANA" || coin.Info.Tag == "DAPS" || coin.Info.Tag == "NULS" || coin.Info.Tag == "IDX" || coin.Info.Tag == "DAI" || coin.Info.Tag == "XBTX" {
			continue
		}
